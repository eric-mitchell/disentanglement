...
def run():
    ...
    e_opt = torch.optim.SGD(e_model.parameters(), lr=args.lr, momentum=0.9, weight_decay=1e-4)
    d_opt = torch.optim.SGD(d_model.parameters(), lr=args.lr, momentum=0.9, weight_decay=1e-4)
    step = 0
    task = generate_task()
